...
Build these comma-separated stream ID strings:
```
IDS_IDS    = comma-joined IDs of all IDS-role streams
NGFW_IDS   = comma-joined IDs of all NGFW-role streams
PROXY_IDS  = comma-joined IDs of all PROXY-role streams
WAF_IDS    = comma-joined IDs of all WAF-role streams
ALL_IDS    = comma-joined IDs of ALL classified streams (IDS + NGFW + PROXY + WAF + VPN + OTHER)
```
...
If a query returns `total == 0` **and** `messages` (or `terms`) is empty, retry with the next field name variant. Maximum 2 retries per field family. If all variants return 0, record "no data" for that dimension and continue.
...
```
aggregate_terms(field="alert_signature",                     query=ANY_Q, range_seconds=RANGE, size=20, stream_ids=IDS_IDS)
aggregate_terms(field="alert_category",                      query=ANY_Q, range_seconds=RANGE, size=10, stream_ids=IDS_IDS)
aggregate_terms(field="alert_severity",                      query=ANY_Q, range_seconds=RANGE, size=5,  stream_ids=IDS_IDS)
aggregate_terms(field="alert_action",                        query=ANY_Q, range_seconds=RANGE, size=5,  stream_ids=IDS_IDS)
aggregate_terms(field="dstip",                               query=SRC_Q, range_seconds=RANGE, size=20, stream_ids=IDS_IDS)
aggregate_terms(field="dst_port",                            query=SRC_Q, range_seconds=RANGE, size=20, stream_ids=IDS_IDS)
aggregate_terms(field="app_proto",                           query=ANY_Q, range_seconds=RANGE, size=10, stream_ids=IDS_IDS)
aggregate_terms(field="alert_metadata_mitre_tactic_name",    query=ANY_Q, range_seconds=RANGE, size=10, stream_ids=IDS_IDS)
aggregate_terms(field="alert_metadata_mitre_technique_name", query=ANY_Q, range_seconds=RANGE, size=10, stream_ids=IDS_IDS)
aggregate_histogram(                                         query=ANY_Q, range_seconds=RANGE, interval="auto", stream_ids=IDS_IDS)
search_sync(query=ANY_Q, range_seconds=RANGE, limit=15,
...
```
aggregate_terms(field="action",       query=SRC_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
aggregate_terms(field="dstip",        query=SRC_Q, range_seconds=RANGE, size=20, stream_ids=NGFW_IDS)
aggregate_terms(field="dport",        query=SRC_Q, range_seconds=RANGE, size=20, stream_ids=NGFW_IDS)
aggregate_terms(field="app",          query=ANY_Q, range_seconds=RANGE, size=15, stream_ids=NGFW_IDS)
aggregate_terms(field="srcuser",      query=SRC_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
aggregate_terms(field="rule",         query=ANY_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
aggregate_terms(field="thr_category", query=ANY_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
aggregate_terms(field="subtype",      query=ANY_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
aggregate_terms(field="severity",     query=ANY_Q, range_seconds=RANGE, size=5,  stream_ids=NGFW_IDS)
aggregate_terms(field="srcip",        query=DST_Q, range_seconds=RANGE, size=20, stream_ids=NGFW_IDS)
aggregate_histogram(                  query=ANY_Q, range_seconds=RANGE, interval="auto", stream_ids=NGFW_IDS)
search_sync(query=ANY_Q, range_seconds=RANGE, limit=15,
...
```
aggregate_terms(field="type",     query=SRC_Q, range_seconds=RANGE, size=10, stream_ids=PROXY_IDS)
aggregate_terms(field="risk",     query=SRC_Q, range_seconds=RANGE, size=5,  stream_ids=PROXY_IDS)
aggregate_terms(field="response", query=SRC_Q, range_seconds=RANGE, size=10, stream_ids=PROXY_IDS)
aggregate_terms(field="agent",    query=SRC_Q, range_seconds=RANGE, size=10, stream_ids=PROXY_IDS)
aggregate_histogram(              query=SRC_Q, range_seconds=RANGE, interval="auto", stream_ids=PROXY_IDS)
search_sync(query=SRC_Q, range_seconds=RANGE, limit=15,
            fields="timestamp,srcip,uri,type,risk,response,agent,source_servico",
            stream_ids=PROXY_IDS)
```

**WAF block** (skip if WAF_IDS is empty) — all in parallel:
```
aggregate_terms(field="action",                    query=DST_Q, range_seconds=RANGE, size=5,  stream_ids=WAF_IDS)
aggregate_terms(field="messages_details_ruleId",   query=DST_Q, range_seconds=RANGE, size=20, stream_ids=WAF_IDS)
aggregate_terms(field="messages_details_severity", query=DST_Q, range_seconds=RANGE, size=5,  stream_ids=WAF_IDS)
aggregate_terms(field="http_user_agent",           query=DST_Q, range_seconds=RANGE, size=10, stream_ids=WAF_IDS)
aggregate_terms(field="http_x_forwarded_for",      query=DST_Q, range_seconds=RANGE, size=10, stream_ids=WAF_IDS)
search_sync(query=DST_Q, range_seconds=RANGE, limit=15,
...
```
aggregate_terms(field="srcip", query=SRC_Q, range_seconds=RANGE, size=20, stream_ids=ALL_IDS)
aggregate_terms(field="dstip", query=DST_Q, range_seconds=RANGE, size=20, stream_ids=ALL_IDS)
```
...
```
aggregate_terms(field="srcip",  query=USER_Q, range_seconds=RANGE, size=20, stream_ids=NGFW_IDS)
aggregate_terms(field="dstip",  query=USER_Q, range_seconds=RANGE, size=20, stream_ids=NGFW_IDS)
aggregate_terms(field="dport",  query=USER_Q, range_seconds=RANGE, size=20, stream_ids=NGFW_IDS)
aggregate_terms(field="action", query=USER_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
aggregate_terms(field="app",    query=USER_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
aggregate_terms(field="rule",   query=USER_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
aggregate_histogram(            query=USER_Q, range_seconds=RANGE, interval="auto", stream_ids=NGFW_IDS)
search_sync(query=USER_Q, range_seconds=RANGE, limit=20,
...
```
aggregate_terms(field="alert_signature", query=USER_Q, range_seconds=RANGE, size=20, stream_ids=IDS_IDS)
aggregate_terms(field="srcip",           query=USER_Q, range_seconds=RANGE, size=20, stream_ids=IDS_IDS)
search_sync(query=USER_Q, range_seconds=RANGE, limit=10,
...
```
aggregate_terms(field="uri",      query=USER_Q, range_seconds=RANGE, size=20, stream_ids=PROXY_IDS)
aggregate_terms(field="type",     query=USER_Q, range_seconds=RANGE, size=10, stream_ids=PROXY_IDS)
aggregate_terms(field="risk",     query=USER_Q, range_seconds=RANGE, size=5,  stream_ids=PROXY_IDS)
aggregate_terms(field="response", query=USER_Q, range_seconds=RANGE, size=10, stream_ids=PROXY_IDS)
```
...
**PROXY block** — all in parallel:
```
aggregate_terms(field="srcip",    query=DOMAIN_Q, range_seconds=RANGE, size=20, stream_ids=PROXY_IDS)
aggregate_terms(field="risk",     query=DOMAIN_Q, range_seconds=RANGE, size=5,  stream_ids=PROXY_IDS)
aggregate_terms(field="response", query=DOMAIN_Q, range_seconds=RANGE, size=10, stream_ids=PROXY_IDS)
aggregate_histogram(              query=DOMAIN_Q, range_seconds=RANGE, interval="auto", stream_ids=PROXY_IDS)
search_sync(query=DOMAIN_Q, range_seconds=RANGE, limit=20,
...
**NGFW block** — all in parallel:
```
aggregate_terms(field="srcip",            query=DOMAIN_Q, range_seconds=RANGE, size=20, stream_ids=NGFW_IDS)
aggregate_terms(field="action",           query=DOMAIN_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
aggregate_terms(field="url_category_list",query=DOMAIN_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
aggregate_terms(field="srcuser",          query=DOMAIN_Q, range_seconds=RANGE, size=10, stream_ids=NGFW_IDS)
search_sync(query=DOMAIN_Q, range_seconds=RANGE, limit=15,
...
```
aggregate_terms(field="http_x_forwarded_for",    query=DOMAIN_Q, range_seconds=RANGE, size=10, stream_ids=WAF_IDS)
aggregate_terms(field="messages_details_ruleId", query=DOMAIN_Q, range_seconds=RANGE, size=10, stream_ids=WAF_IDS)
search_sync(query=DOMAIN_Q, range_seconds=RANGE, limit=10,
...
```
aggregate_terms(field="srcip",  query=HASH_Q, range_seconds=RANGE, size=20, stream_ids=IDS_IDS)
aggregate_terms(field="dstip",  query=HASH_Q, range_seconds=RANGE, size=20, stream_ids=IDS_IDS)
search_sync(query=HASH_Q, range_seconds=RANGE, limit=20,
...
```
search_sync(query=HASH_Q, range_seconds=RANGE, limit=30, stream_ids=ALL_IDS)
...
```
search_sync(query=PROC_Q, range_seconds=RANGE, limit=50, stream_ids=ALL_IDS)
aggregate_terms(field="srcip",           query=PROC_Q, range_seconds=RANGE, size=20, stream_ids=ALL_IDS)
aggregate_terms(field="alert_signature", query=PROC_Q, range_seconds=RANGE, size=10, stream_ids=IDS_IDS)
...
```
search_sync(query=FREE_Q, range_seconds=RANGE, limit=50, stream_ids=ALL_IDS)
aggregate_terms(field="program",  query=FREE_Q, range_seconds=RANGE, size=10, stream_ids=ALL_IDS)
aggregate_terms(field="srcip",    query=FREE_Q, range_seconds=RANGE, size=20, stream_ids=ALL_IDS)
aggregate_terms(field="dstip",    query=FREE_Q, range_seconds=RANGE, size=20, stream_ids=ALL_IDS)
aggregate_histogram(              query=FREE_Q, range_seconds=RANGE, interval="auto", stream_ids=ALL_IDS)
